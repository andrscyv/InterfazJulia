...
#_______________________________________________________________________________________________
    ...
    c_viscdyn = [m_prod, vdyn_no_opt, product[12]]
    c_color = [c_prod, color_no_opt, product[13]]
    c_volat = [v_prod, volat_no_opt, product[14]]
    
    product_info = DataFrame(viscosidad_kin = mukin_product, viscosidad_dyn = c_viscdyn, color = c_color, volatilidad = c_volat)
    ...
    CSV.write("informacion_producto", product)
